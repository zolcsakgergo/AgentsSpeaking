...
public class Cell {
    ...
    /**
     * Returns true if the cell has a fire on it
     * 
     * @return True if the cell has a fire on it
     */
    ...
    /**
     * Add fire to the cell
     * 
     * @param newFire The fire to be put on the cell
     */
    public void setFire(Fire newFire) {
        this.fire = newFire;
        if (newFire != null) {
            newFire.setDiscovered();
        }
    }
}
